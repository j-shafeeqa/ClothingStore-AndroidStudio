...
public class Prod5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod5);
        ...
        getProductDetails("Plain Hooded Sweatshirt");

        // Set OnClickListener for the ImageButton
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(Prod5Activity.this, MainActivity.class);
        ...
        db.collection("AddToCart")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(Prod5Activity.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(Prod5Activity.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        if (!task.getResult().isEmpty()) {
                            // Retrieve the document and map it to your CategoryModel or use the data directly
                            ...
                            Toast.makeText(Prod5Activity.this, "Product not found", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // Handle failures, e.g., network errors or Firestore errors
                        Log.e("Prod5Activity", "Error getting product details", task.getException());
                    }
                });
    }
