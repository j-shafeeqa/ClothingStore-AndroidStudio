...
public class Prod6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod6);
        ...
        getProductDetails("Ribbon Bow Clip");

        // Set OnClickListener for the ImageButton
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(Prod6Activity.this, MainActivity.class);
        ...
        db.collection("AddToCart")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(Prod6Activity.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(Prod6Activity.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        if (!task.getResult().isEmpty()) {
                            ...
                            Toast.makeText(Prod6Activity.this, "Product not found", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // Handle failures, e.g., network errors or Firestore errors
                        Log.e("Prod6Activity", "Error getting product details", task.getException());
                    }
                });
    }
