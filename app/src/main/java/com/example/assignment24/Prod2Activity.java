...
public class Prod2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getProductDetails("Textured Plisse Wide Leg Pants");

        // Set OnClickListener for the ImageButton
        backButton.setOnClickListener(v -> {
            // navigate to MainActivity
            Intent intent = new Intent(Prod2Activity.this, MainActivity.class);
        ...
        db.collection("AddToCart")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(Prod2Activity.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(Prod2Activity.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        if (!task.getResult().isEmpty()) {
                            ...
                            Toast.makeText(Prod2Activity.this, "Product not found", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // Handle failures, e.g., network errors or Firestore errors
                        Log.e("Prod2Activity", "Error getting product details", task.getException());
                    }
                });
    }
