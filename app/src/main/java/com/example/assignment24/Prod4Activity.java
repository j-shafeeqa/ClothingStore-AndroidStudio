...
public class Prod4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getProductDetails("Ribbed Dress");

        // Set OnClickListener for the ImageButton
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(Prod4Activity.this, MainActivity.class);
        ...
        db.collection("AddToCart")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(Prod4Activity.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(Prod4Activity.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        if (!task.getResult().isEmpty()) {
                            ...
                            Toast.makeText(Prod4Activity.this, "Product not found", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // Handle failures, e.g., network errors or Firestore errors
                        Log.e("Prod4Activity", "Error getting product details", task.getException());
                    }
                });
    }
